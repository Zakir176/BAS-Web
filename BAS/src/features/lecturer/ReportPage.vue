      ...
      <div class="container py-8">
        ...
        <header class="page-header-v2">
          ...
          <div class="header-actions">
            <BaseButton variant="secondary" size="sm" @click="exportReport" class="glass-btn">
              <svg width="16" height="16" viewBox="0 0 20 20" fill="currentColor">
                <path d="M3 17a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm3.293-7.707a1 1 0 011.414 0L9 10.586V3a1 1 0 112 0v7.586l1.293-1.293a1 1 0 111.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" />
              </svg>
              <span>Export</span>
            </BaseButton>
            <BaseButton variant="secondary" size="sm" @click="refreshData" class="glass-btn">
              <svg width="16" height="16" viewBox="0 0 20 20" fill="currentColor">
          ...
          <BaseCard class="records-card">
            <div class="records-header">
              ...
              <div class="records-actions">
                <BaseInput v-model="searchQuery" placeholder="Search records..." type="text" />
              </div>
            </div>
...
import LineChart from "@/core/ui/charts/LineChart.vue";
import BarChart from "@/core/ui/charts/BarChart.vue";
    ...
    datasets: [
      {
        ...
        pointBorderColor: getComputedStyle(document.documentElement).getPropertyValue('--text-inverse').trim(),
        pointHoverRadius: 6,
        fill: true,
      }
    ]
...
.status-pill-v2.present { background: var(--success-bg); color: var(--success); }
.status-pill-v2.absent { background: var(--error-bg); color: var(--error); }
...
.tile-icon.blue { background: var(--info-bg); }
.tile-icon.emerald { background: var(--success-bg); }
.tile-icon.amber { background: var(--warning-bg); }
.tile-icon.indigo { background: var(--info-bg); }
