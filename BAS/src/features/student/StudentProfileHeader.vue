    ...
    <div class="profile-main">
      <div class="avatar-container">
        <div class="avatar-ring">
          <BaseSkeleton v-if="isLoading" width="100px" height="100px" shape="circle" />
      ...
      <div class="profile-text">
        <BaseSkeleton v-if="isLoading" width="200px" height="2rem" style="margin: 0 auto 0.5rem" />
        <h1 v-else class="student-name">{{ studentName }}</h1>
        <BaseSkeleton v-if="isLoading" width="150px" height="1rem" style="margin: 0 auto" />
