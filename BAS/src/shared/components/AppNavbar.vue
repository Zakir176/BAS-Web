      ...
      <nav class="desktop-nav">
        ...
        <template v-if="!isAuthenticated">
          ...
          <div class="nav-actions">
            <BaseButton variant="secondary" size="sm" @click="() => routeTo('/student-login')" class="action-btn">Sign In</BaseButton>
            <BaseButton variant="primary" size="sm" @click="() => routeTo('/student-signup')" class="action-btn highlight">Get Started</BaseButton>
          </div>
        </template>
