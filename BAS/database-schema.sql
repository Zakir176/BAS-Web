-- Supabase Schema V2 for CAT (.NET MAUI & Vue.js Dashboard)
...
-- WARNING: This will delete existing data. Use carefully in production.
...
CREATE TABLE public.departments (
    ...
    code TEXT UNIQUE, -- e.g., 'CS', 'ENG', 'BUS'
...
CREATE TABLE public.lecturers (
    ...
    registration_id TEXT UNIQUE, -- Employee ID
...
CREATE TABLE public.students (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    student_number TEXT NOT NULL UNIQUE, -- e.g., '20240001'
    full_name TEXT NOT NULL,
    email TEXT UNIQUE,
    phone TEXT,
    qr_code TEXT UNIQUE,
...
CREATE TABLE public.sections (
    ...
    name TEXT NOT NULL, -- e.g., 'Section A', 'Evening Batch'
    semester INTEGER NOT NULL,
    academic_year INTEGER NOT NULL,
    lecturer_id UUID REFERENCES public.lecturers(id) ON DELETE SET NULL, -- Section-specific lecturer
    created_at TIMESTAMPTZ DEFAULT NOW() NOT NULL,
    updated_at TIMESTAMPTZ DEFAULT NOW() NOT NULL
);
...
CREATE TABLE public.attendance_logs (
    ...
    notes TEXT,
    location_coords TEXT, -- Optional: latitude,longitude
    created_at TIMESTAMPTZ DEFAULT NOW() NOT NULL,
    updated_at TIMESTAMPTZ DEFAULT NOW() NOT NULL
);
...
-- Example: Get student attendance percentage
